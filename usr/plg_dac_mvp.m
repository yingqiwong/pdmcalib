...
% testing
A = [   0.9015, 0.1931, 0.6581; 
        0.0243, 0.2429, 0.0274;
        3.1989, 0.0179, 0.2611];    % permission slopes
B = [   0.1670, 0.2950, 0.5381
        0.8784, 0.0105, 0.1111
        0.2318, 0.4717, 0.2965 ];   % permission step locations
C = [   2.1824, 0.1752, 0.5305
        6.1801, 1.1126, 1.7401
        0.3829, 0.7270, 0.1976];    % permission step widths
